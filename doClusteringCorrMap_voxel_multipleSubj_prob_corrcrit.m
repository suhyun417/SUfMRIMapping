function [] = doClusteringCorrMap_voxel_multipleSubj_prob_corrcrit(flagParallel, flagSave)
% 2017/01/25 SHP
...
% % totalSS
[a, c, totalSS] = kmeans(matR_SU_all_moviemask_valid, 1);
Clustering_moviemask_valid.totalSS = totalSS;
...
%     diary off 
    ...
    if flagSave
        save(fullfile(dirDataBOLD, sprintf('Clustering_%s%sMovie123_new_masked_voxel_probability_critCorr1.mat', cell2mat(setNameSubjNeural), nameSubjBOLD)), ... %nameSubjNeural, nameSubjBOLD)),...
