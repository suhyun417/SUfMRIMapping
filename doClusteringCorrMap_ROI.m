% doClusteringCorrMap_ROI.m
%
% 2020/06/29 SHP
% Compute ROI-based corr map and run K-means clustering
...
Clustering_meanROI.catChanID = corrMap_merged_FP.catChanID;
...
Clustering_maxabsROI.catChanID = corrMap_merged_FP.catChanID; 
