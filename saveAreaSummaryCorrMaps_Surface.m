% saveAreaSummaryCorrMaps_Surface.m
%
% 2020/05/05 SHP
% Load cortical face patch area summary maps ('/procdata/parksh/_macaque/CorrMap_SU_corticalFPMerged.mat')
    ...
    for iMap = 3 %1:3
        ...
        switch iMap
            case 1 % maximum of absolute correlation across neurons
                matR = corrMap_Area(iArea).matR_max;
                fileHead = 'MaxAbs';
