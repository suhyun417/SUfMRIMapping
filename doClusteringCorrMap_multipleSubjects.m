function [] = doClusteringCorrMap_multipleSubjects()
% 2017/01/22 SHP
...
%     diary off
    ...
    [IDX_Vox, C_Vox, SUMD_Vox] = kmeans(matR_SU_all, K, 'Replicates', 5, 'Options', opts);
...
save(fullfile(dirDataNeural, sprintf('Clustering_%s%sMovie123_new.mat', cell2mat(setNameSubjNeural), nameSubjBOLD)), 'Clustering'); %nameSubjNeural, nameSubjBOLD)), 'Clustering');
