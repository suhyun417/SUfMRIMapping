...
% save
print(fig3b, fullfile(dirFig, 'multipleFP_FigS_KMeansClustering_facecells_brainmaskVoxels_expVar'), '-depsc')
...
% save
print(fig3c, fullfile(dirFig, 'multipleFP_FigS_KMeansClustering_facecells_brainmaskVoxels_expVar_delta'), '-depsc')
...
% save
print(fig3d, fullfile(dirFig, 'multipleFP_FigS_KMeansClustering_facecells_brainmaskVoxels_expVar_std'), '-depsc')
...
% save
print(fig3a2, fullfile(dirFig, 'multipleFP_FigS_KMeansClustering_facecells_brainmaskVoxels_2DPCA_allCells_colorArea'), '-depsc')
print(fig3a2, fullfile(dirFig, 'multipleFP_FigS_KMeansClustering_facecells_brainmaskVoxels_2DPCA_allCells_colorArea'), '-r300', '-dtiff')
...
% save
print(fig3a3, fullfile(dirFig, 'multipleFP_FigS_KMeansClustering_facecells_brainmaskVoxels_2DPCA_allCells_colorCluster'), '-depsc')
print(fig3a3, fullfile(dirFig, 'multipleFP_FigS_KMeansClustering_facecells_brainmaskVoxels_2DPCA_allCells_colorCluster'), '-r300', '-dtiff')
