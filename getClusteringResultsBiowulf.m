...
%
% 2021/06/21 SHP
%       Added another case of "face-selective" neuron clustering results
% 2020/08/14 SHP
...
% %% 1. all cells from 4 face patches
% % Setting
% nameSubjBOLD = 'Art';
...
%     
%     load(fullfile(dirDataOrg, sprintf('Clustering_CorrMap_4FPs_faceselective_Movie123_probability_K%d.mat', setK(iK))));
%     
...
%% 2. face cells from 4 face patches
% Setting
nameSubjBOLD = 'Art';
dirDataOrg = sprintf('/procdata/parksh/_macaque/%s/clustering_multipleFP_faceselective', nameSubjBOLD);
dirSaveData = sprintf('/procdata/parksh/_macaque/%s/', nameSubjBOLD);
saveFileName = 'Clustering_CorrMap_4FPs_faceselective_Movie123_probability.mat';
...
load(sprintf('/procdata/parksh/_macaque/%s/matR4clusteringmultiplepatches_faceselective.mat', nameSubjBOLD));
