...
data_directory = '/procdata/parksh/Ava/_orgData/';

% listFileName{1} = 'AvaLeft01_Movie05Data'; %'AvaLeft01_Movie04Data'; %
% listFileName{2} = 'AvaLeft01_Movie06Data';
% 
% for iFile = 1:length(listFileName)
filename =  'AvaLeft01_Movie04Data'; %'AvaRight01_Movie05Data'; %'AvaLeft01_Movie06Data'; %listFileName{iFile}; %'AvaRight01_Movie06Data';
...
print(gcf, fullfile(dirFig, sprintf('xcorr_%s', filename)), '-r150', '-dtiff')
