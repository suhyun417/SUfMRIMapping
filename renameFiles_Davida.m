...
directory.source = fullfile(directory.dataNeural, '_orgData', 'Davida180515_18_movie');
directory.destination = fullfile(directory.dataNeural);

% read the excel file of cell list
filename_xls =  fullfile(directory.dataNeural, '_orgData/Davida_cell_list_180515_SHP.xls');
