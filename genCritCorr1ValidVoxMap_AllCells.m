% genCritCorr1ValidVoxMap_AllCells.m
%
% 2019/07/03 SHP
% To visualize the location of the voxels that are used for clustering
% based on the correlation maps with all cells (not pca-res maps), make & save the whole
% brain map of indices of valid 5296 voxels

clear all;

%% Load the data
load('/procdata/parksh/_macaque/Art/Clustering_TorRhoSigSpiMatDanMocWasArtMovie123_new_masked_critCorr1.mat', 'paramClustering_global')
...
fname = 'ValidVoxMap_Clustering_TorRhoSigSpiMatDanMocWasArtMovie123_new_masked_critCorr1+orig.BRIK';
