...
%     % [sortedClust, indSortVoxel]=sort(matIndClust_Vox(:,sortTargetK-1));
    ...
    tempPC_valid(paramClustering_global.locValidVox) = coeff_res(:, iPC); %Clustering_moviemask_valid.resultKMeans(sortTargetK-1).Vox_indCluster;
...
%     cd /projects/parksh/_toolbox/BlockAna/ %/projects/parksh/NeuralBOLD/analysis/BlockAna/
    ...
    fname = sprintf('%s_AfterPCAres_PrinComp%d_CritCorr1_Movie123_noFiltering+orig.BRIK', fileHead, iPC);%
