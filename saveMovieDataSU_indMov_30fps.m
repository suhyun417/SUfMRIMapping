% saveMovieDataSU_indMov_30fps.m
%
% 2017/12/18 SHP
% Save single unit time courses (spike counts within unoverlapping time window) for each movie in 30fps
...
%% save File
saveFileName = fullfile(dirDataNeural, sprintf('%s_movieTS_SU_movie123_30fps.mat',  cell2mat(setNameSubjNeural)));
