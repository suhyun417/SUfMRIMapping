...
for iK = 1:sortTargetK
    ...
    voxIndCluster_valid(paramClustering_global.locValidVox) = mean(matR_SU_all_moviemask_valid(:,resultProbClustering(iK).validIndCells), 2);
...
%         DSP.proc.fncvol_3d = avgMapCluster(iK).voxelClusterMap_vol; %mapR_Cluster(:,:,:,iK);
        ...
        switch iMask
            ...
            case 2 % masked
                fileHead = sprintf('new_masked_%s_critCorr1Prob', cell2mat(setNameSubjNeural));
