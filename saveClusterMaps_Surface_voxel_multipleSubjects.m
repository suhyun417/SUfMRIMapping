...
load(fullfile(dirDataBOLD, 'Clustering_TorRhoSigSpiArtMovie123_new_masked_critCorr1.mat'))
...
for iK = 1:length(paramClustering_global.setK)
    ...
    voxIndCluster_valid(paramClustering_global.locValidVox) = Clustering_moviemask_valid.resultKMeans(sortTargetK-1).Vox_indCluster;
